...
function NavBar() {
  ...
  return (
    <nav className="px-4 sm:px-8 md:px-16 lg:px-28 flex items-center justify-between bg-opacity-10 bg-black w-screen overflow-x-hidden z-11 top-0 left-0 text-white h-[10vh] box-border">
      ...
      {/* Navigation Menu */}
      <ul className={`flex space-x-6 md:flex ${isOpen ? 'flex-col items-center justify-center py-20 lg:py-40 gap-10 absolute bg-black z-50 bg-opacity-95 top-[10vh] left-0 w-full h-screen' : 'hidden md:flex'}`}>
